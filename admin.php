        ...
        <table>
            ...
            while ($row = $stmt->fetch()) {
                ...
                <tr>
                    ...
                    <td><a href="admin.php?delcat=<?php echo $row["ID"]; ?>" class="btn"><i
        ...
        <table>
            ...
            while ($row = $stmt->fetch()) {
                ...
                <tr>
                    ...
                    <td><a href="admin.php?delfaq=<?php echo $row["ID"]; ?>" class="btn"><i
                                    class="far fa-trash-alt"></i></a></td>
                </tr>
                <?php
            }
...
<div class="flex">
            ...
            while ($row = $stmt->fetch()) {
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td><a href="editaccount.php?user=<?php echo $row["USERNAME"]; ?>" class="btn"><i
    ...
    <div class="flex-item">
        ...
        <form action="admin.php" method="post">
            ...
            <input type="text" name="captcha-public" placeholder="<?php echo CAPTCHA_PUBLIC_KEY ?>"
                   value="<?php echo $publickey; ?>"><br>
            <input type="text" name="captcha-secret" placeholder="<?php echo CAPTCHA_PRIVATE_KEY; ?>"
                   value="<?php echo $privatekey; ?>"><br>
