...
<div class="flex">
    <div class="flex-item">
        ...
        <form action="settings.php" method="post">
            <input type="email" name="email" value="<?php echo getAccountEmail($_SESSION["username"]); ?>"
        ...
        <p><?php echo RANK; ?>: <strong><?php
                ...
                ?></strong></p>
        <p><?php echo LASTLOGIN; ?>:
            <strong><?php echo displayTimestamp(getLastLoginDate($_SESSION["username"])); ?></strong></p>
        <p><?php echo FIRSTLOGIN; ?>:
            <strong><?php echo displayTimestamp(getFirstLoginDate($_SESSION["username"])); ?></strong></p>
    </div>
